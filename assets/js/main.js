...
tabs.forEach((tab) => {
  tab.addEventListener('click', () => {
    ...
    // disable all contents and active tags
...
/*=============== SERVICES ACCORDION ===============*/
const serviesButtons = document.querySelectorAll('.services__button')

serviesButtons.forEach(button => {
